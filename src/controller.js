...
class LibroController {
  ...
  async getAll(req, res) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error en el servidor al obtener todos los libros" });
    }
  }
  ...
  async getOne(req, res, id) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error en el servidor al obtener el libro por ID" });
    }
  }
  ...
  async delete(req, res) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Error en el servidor al eliminar el libro" });
    }
  }

  //actualizar un libro colocando datos y obligatoriamente el id en postman
  async update(req, res) {
    ...
    try {
      ...
      res
        .status(500)
        .json({ error: "Ocurrió un error al actualizar los registros." });
    }
  }
}
